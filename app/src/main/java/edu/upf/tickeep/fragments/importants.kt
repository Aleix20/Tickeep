...
class importants : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_importants, container, false)

        ticketRecyclerView= view.findViewById(R.id.ticketsListImportants)
